...
<p align="center">
  ...
  <br/>
  <i>Châm ngôn nhẹ: “Robot không sai — chỉ là mình chưa debug đủ sâu.” 😄</i>
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/ROS2-Nav%20%7C%20Control-22314E?style=for-the-badge&logo=ros&logoColor=white" />
...
### 👁️ 3) Vision Module
- Detect object (YOLO/OpenCV)
- ROI calibration + mapping pixel → tọa độ mm để pick tự động
...
# ✨ Tùng Lâm Automatic — Robotics & Automation Portfolio

<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=rounded&height=160&text=T%C3%B9ng%20L%C3%A2m%20Automatic&fontAlign=50&fontAlignY=55&color=gradient" />
</p>

<p align="center">
  <b>Robotics • Embedded • Control • Vision</b><br/>
  Build robots that move smooth, think smart, and stay stable under pressure.
</p>
...
- 🤖 Robot design & integration (mecanum base + arm)
- 🧠 Motion control (PID/Fuzzy, feedback, trajectory)
- 🧩 Firmware (STM32/ESP32: DMA, timers, USB-CDC, UART protocols)
- 👁️ Vision pipeline (OpenCV + YOLO, calibration, coordinate mapping)
...
<p align="center">
  <img src="assets/cover.png" width="85%" />
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Type-Robotics-0B84F3?style=for-the-badge" />
  <img src="https://img.shields.io/badge/Language-C%2FPython-7C3AED?style=for-the-badge" />
</p>

## ✨ Overview
Mô tả ngắn 2–3 dòng: dự án làm gì, chạy ở đâu, dùng cho ai.
